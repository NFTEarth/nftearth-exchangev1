      ...
      {attributes?.map((attribute) => (
        ...
        >
          <Accordion.Header className="flex w-full justify-between border-b-[1px] border-gray-300 dark:border-neutral-600">
            <Accordion.Trigger className="flex w-full items-center justify-between p-5 transition dark:hover:text-black hover:bg-primary-100 dark:hover:bg-primary-700">
              {attribute.key}
